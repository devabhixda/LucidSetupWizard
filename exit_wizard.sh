...
adb root
wait ${!}
adb shell pm enable com.lucid.setupwizard/com.lucid.setupwizard.SetupWizardExitActivity || true
wait ${!}
adb shell pm enable com.google.android.setupwizard/com.google.android.setupwizard.SetupWizardExitActivity || true
wait ${!}
sleep 1
adb shell am start com.lucid.setupwizard/com.lucid.setupwizard.SetupWizardExitActivity || true
wait ${!}
sleep 1
