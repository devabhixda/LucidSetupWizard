...
import static com.lucid.setupwizard.SetupWizardApp.DISABLE_NAV_KEYS;
import static com.lucid.setupwizard.SetupWizardApp.KEY_SEND_METRICS;
...
public class LucidSettingsActivity extends BaseSetupWizardActivity {
    ...
    public static final String TAG = LucidSettingsActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String metricsHelpImproveLucid =
                getString(R.string.services_help_improve_cm, getString(R.string.os_name));
        String metricsSummary = getString(R.string.services_metrics_label,
                metricsHelpImproveLucid, getString(R.string.os_name));
        final SpannableStringBuilder metricsSpan = new SpannableStringBuilder(metricsSummary);
        metricsSpan.setSpan(new android.text.style.StyleSpan(android.graphics.Typeface.BOLD),
                0, metricsHelpImproveLucid.length(), Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    ...
    protected int getLayoutResId() {
        return R.layout.setup_lucid_settings;
    }
